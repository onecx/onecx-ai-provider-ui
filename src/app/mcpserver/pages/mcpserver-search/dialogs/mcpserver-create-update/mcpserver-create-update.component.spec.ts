...
describe('McpserverCreateUpdateComponent', () => {
  let component: McpserverCreateUpdateComponent
  let fixture: ComponentFixture<McpserverCreateUpdateComponent>
  ...
  beforeEach(async () => {
    ...
    fixture = TestBed.createComponent(McpserverCreateUpdateComponent)
  ...
  it('should set dialogResult with merged values on ocxDialogButtonClicked', () => {
    component.vm.itemToEdit = { id: '1', name: 'oldName', description: 'oldDesc' } as Tool
  ...
  it('should patch formGroup values from vm.itemToEdit on ngOnInit', () => {
    component.vm.itemToEdit = { id: '1', name: 'editVal', description: 'desc' } as Tool
    component.ngOnInit()
