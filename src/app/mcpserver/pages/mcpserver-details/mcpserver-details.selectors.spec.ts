...
describe('selectMCPServerDetailsViewModel', () => {
  it('should return correct view model for all fields', () => {
    ...
    const result = selectMCPServerDetailsViewModel.projector(details, true, false, false, false, false, false)
  ...
  it('should handle undefined details', () => {
    const result = selectMCPServerDetailsViewModel.projector(undefined, true, false, false, false, false, false)
    expect(result).toEqual({
      details: undefined,
      detailsLoadingIndicator: true,
      backNavigationPossible: false,
